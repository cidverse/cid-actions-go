...
func TestContainerSignPrivateKey(t *testing.T) {
	...
	sdk.On("FileRead", "/my-project/.dist/my-project/oci-image/image.txt").Return("docker.io/hello-world", nil)
	sdk.On("ExecuteCommand", cidsdk.ExecuteCommandRequest{
		Command: `cosign sign --key "/my-project/.tmp/private.key" -a "repo=https://github.com/cidverse/normalizeci.git" -a "commit_hash=abcdef123456" docker.io/hello-world`,
		WorkDir: "/my-project",
...
func TestContainerSignKeyless(t *testing.T) {
	...
	sdk.On("FileRead", "/my-project/.dist/my-project/oci-image/image.txt").Return("localhost:5000/repository:tag", nil)
	sdk.On("ExecuteCommand", cidsdk.ExecuteCommandRequest{
		Command: `cosign sign -a "repo=https://github.com/cidverse/normalizeci.git" -a "commit_hash=abcdef123456" localhost:5000/repository:tag`,
		WorkDir: "/my-project",
		Env: map[string]string{
