...
type ScorecardScanAction struct {
	Sdk cidsdk.SDKClient
}

type ScorecardScanConfig struct {
}

func (a ScorecardScanAction) Execute() (err error) {
	cfg := ScorecardScanConfig{}
	...
	err = a.Sdk.ArtifactUploadByteArray(cidsdk.ArtifactUploadByteArrayRequest{
		...
		Content:       []byte(scanResult.Stdout),
		Type:          "report",
		Format:        "sarif",
